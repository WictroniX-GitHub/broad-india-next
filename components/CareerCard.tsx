...
const CareerCard: React.FC<CareerCardProps> = ({ position, location }) => {
  return (
    <div className="w-full sm:w-[320px] md:w-[350px] lg:w-[380px] bg-white border rounded-lg shadow-lg p-6 flex flex-col items-center text-center">
      <Image
        src={avatar}
        alt="Career Avatar"
        width={100}
      ...
      <h3 className="flex justify-center items-center gap-3 text-xl font-semibold mt-4">
        <svg
